...
// api/index.js - Vercel shim
try {
  console.log("API SHIM: loading ../index.js");
  const app = require("../index.js");
  console.log("API SHIM: loaded module; exporting Express app");
  if (typeof app === "function") {
    module.exports = app;
  } else if (app && typeof app.default === "function") {
    module.exports = app.default;
  } else {
    console.error("API SHIM: loaded module not a function. Export keys:", Object.keys(app || {}));
    module.exports = (req, res) => {
      res.status(500).json({ error: "Server loaded but exported an unexpected shape. Check runtime logs." });
    };
  }
